    ...
    suspend fun loadHeartButtonLayout(context: Context): List<ButtonConfig> {
        ...
        return if (json != null) {
            ...
            listOf(
                ...
                ButtonConfig("paste_affordable_package", "সাশ্রয়ী প্যাকেজ:\n৩,০০০ ভিউ - ৫০ টাকা (সর্বনিম্ন)\n৯,৫০০ ভিউ - ৯৯ টাকা (বিশেষ অফার)\n৪,৫০০ লাইক - ১২৯ টাকা (পপুলার) 🔥 \n২০০ ফলোয়ার - ২০০ টাকা\n\n🥇কয়েন ভিত্তিক বিশেষ অফার:\n৩,০০০ থেকে ১৬,০০০ ভিউ - ৩০০ টাকায়", "💰"),
